...
namespace CrazyGoat\ScanMePHP\Generator\UpcA;
...
/**
 * UPC-A, the twelve-digit retail code used in North America.
 *
 * Accepts 11 digits and computes the check digit, or 12 and verifies it.
 */
final class UpcAGenerator implements GeneratorInterface
{
    ...
    public function getCapabilities(): GeneratorCapabilities
    {
        return new GeneratorCapabilities(
            name: Symbology::UpcA->value,
            title: 'UPC-A',
            dimension: Dimension::Linear,
            moduleShape: ModuleShape::Square,
            aliases: ['upca', 'upc'],
            dataDescription: '11 digits, or 12 with a correct check digit',
    ...
    {
        return Patterns::accepts($data, 11);
    }
