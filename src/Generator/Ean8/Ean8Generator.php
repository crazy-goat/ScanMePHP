...
namespace CrazyGoat\ScanMePHP\Generator\Ean8;
...
/**
 * EAN-8, for articles whose packaging cannot carry an EAN-13.
 *
 * Accepts 7 digits and computes the check digit, or 8 and verifies it.
 */
final class Ean8Generator implements GeneratorInterface
{
    ...
    public function getCapabilities(): GeneratorCapabilities
    {
        return new GeneratorCapabilities(
            name: Symbology::Ean8->value,
            title: 'EAN-8',
            dimension: Dimension::Linear,
            moduleShape: ModuleShape::Square,
            aliases: ['ean-8'],
            dataDescription: '7 digits, or 8 with a correct check digit',
    ...
    {
        return Patterns::accepts($data, 7);
    }
