...
class ScanmeTest extends TestCase
{
    ...
    public function testTheBuiltInSymbologiesAreExactlyThese(): void
    {
        ...
        $this->assertSame(
            ['aztec', 'codabar', 'code128', 'code39', 'code39ext', 'code93', 'data-matrix', 'databar-limited', 'databar-omni', 'ean13', 'ean2', 'ean5', 'ean8', 'gs1-128', 'gs1-data-matrix', 'gs1-qr', 'itf', 'itf14', 'maxicode', 'pdf417', 'qrcode', 'upc-a', 'upc-e'],
            $registered
        );
    }
